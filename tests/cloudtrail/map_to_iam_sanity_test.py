...
KNOWN_UNKNOWNS = {
    ...
    "models:CreateBotVersion",
    "models:CreateIntentVersion",
    "models:CreateSlotTypeVersion",
    "models:DeleteBot",
    "models:DeleteBotAlias",
    "models:DeleteBotChannelAssociation",
    "models:DeleteBotVersion",
    "models:DeleteIntent",
    "models:DeleteIntentVersion",
    "models:DeleteSlotType",
    "models:DeleteSlotTypeVersion",
    "models:DeleteUtterances",
    "models:GetBot",
    "models:GetBotAlias",
    "models:GetBotAliases",
    "models:GetBotChannelAssociation",
    "models:GetBotChannelAssociations",
    "models:GetBotVersions",
    "models:GetBots",
    "models:GetBuiltinIntent",
    "models:GetBuiltinIntents",
    "models:GetBuiltinSlotTypes",
    "models:GetExport",
    "models:GetIntent",
    "models:GetIntentVersions",
    "models:GetIntents",
    "models:GetSlotType",
    "models:GetSlotTypeVersions",
    "models:GetSlotTypes",
    "models:GetUtterancesView",
    "models:PutBot",
    "models:PutBotAlias",
    "models:PutIntent",
    "models:PutSlotType",
...
def test_api_calls_map_to_known_iam_action():
    assert unknown_actions() == KNOWN_UNKNOWNS
